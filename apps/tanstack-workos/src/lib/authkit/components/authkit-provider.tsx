...
import { checkSessionAction, getAuthAction, handleSignOutAction, refreshAuthAction, switchToOrganizationAction } from "../actions";
import type { SwitchToOrganizationOptions, UserInfo } from "../interfaces";
...
export const AuthKitProvider = ({ children, onSessionExpired }: AuthKitProviderProps) => {
	...
	const switchToOrganization = useCallback(async (organizationId: string, options: SwitchToOrganizationOptions = {}) => {
